 ...
 * https://github.com/MarcinMoskala/ActivityStarter/wiki/Parceler-Arg-Converter-usage[ActivityStarter] - Native support that allows `@Parcel` annotated beans to be used as arguments to Activities, Fragments, Services, etc.
...
[source,groovy]
----
implementation 'org.parceler:parceler-api:{{site.currentVersion}}'
